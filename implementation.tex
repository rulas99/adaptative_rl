...
%TODO RAUL: please change y axis on both figures from q-value to "total reward per episode" and for exploration and exploitation labels change them to "exploration reward" and "exploitation reward" - it is not clear what's happening in the graph currently to labelling needs to clarify it
