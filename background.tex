...
\textbf{Goal Relocation:} The target switches between corners, requiring agents to adapt to new reward distributions without losing previously learned knowledge.

\textbf{Action Space Expansion:} New actions (e.g., jumping over obstacles) are introduced, requiring agents to integrate new capabilities into existing policies while maintaining performance.
